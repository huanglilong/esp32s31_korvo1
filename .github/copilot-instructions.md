...
│   └── gen_bmgr_codes/       # ⚠️ Generated by `idf.py bmgr -b esp32_s31_korvo_1` — DO NOT EDIT
...
pip3 install esp-bmgr-assist                         # Required by `idf.py bmgr`
idf.py set-target esp32s31                            # Set target chip (once)
idf.py bmgr -b esp32_s31_korvo_1                    # Generate board-manager code (if missing)
...
| `components/gen_bmgr_codes/` | **DO NOT EDIT** | Generated by `idf.py bmgr -b esp32_s31_korvo_1`; regenerate instead |
