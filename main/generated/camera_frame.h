...
#define CAMERA_FRAME_FORMAT_STR "camera_frame:uint64_t timestamp;uint32_t frame_index;uint16_t width;uint16_t height;uint16_t jpeg_size;uint8_t format;uint8_t[7168] jpeg_data;uint8_t[5] _padding0;"
